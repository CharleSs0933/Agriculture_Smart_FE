      ...
      <div className="px-4 md:px-6">
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="w-fit text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                variant="outline"
                className="w-full sm:w-auto border-white text-gray-700 hover:bg-green-700"
              >
                Tìm hiểu thêm
              </Button>
            </motion.div>
